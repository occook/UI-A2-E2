...
//logIn form html
var logInForm = "<b>Account Information</b><br><form name='regForm' onsubmit='return regVal() method = 'post'>Username: <input type='text' name='username' required><br>Password: <input type = 'password' pattern = '[a-z0-9]{1,8}' name = 'psw'required><br><br><br><br><input type = 'submit' value = 'Submit'><br><input type = 'reset' value = 'Delete'> </form>";
